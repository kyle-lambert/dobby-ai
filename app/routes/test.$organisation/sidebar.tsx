        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              {/* Dashboard */}
              <SidebarLinkGroup
                actionCondition={pathname === '/' || pathname.includes('dashboard')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              {/* E-Commerce */}
              <SidebarLinkGroup actionCondition={pathname.includes('ecommerce')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Community */}
              <SidebarLinkGroup actionCondition={pathname.includes('community')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Finance */}
              <SidebarLinkGroup actionCondition={pathname.includes('finance')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Job Board */}
              <SidebarLinkGroup actionCondition={pathname.includes('job')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Tasks */}
              <SidebarLinkGroup actionCondition={pathname.includes('tasks')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Utility */}
              <SidebarLinkGroup actionCondition={pathname.includes('utility')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Components */}
              <SidebarLinkGroup actionCondition={pathname.includes('component')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
